...
int main(int argc, char** argv)
{
	...
	//create texture
	//std::shared_ptr<neu::Texture> texture1 = neu::g_resources.Get<neu::Texture>("Textures/bigshot.png");
	//std::shared_ptr<neu::Texture> texture2 = neu::g_resources.Get<neu::Texture>("textures/llama.jpg"); 
	//std::shared_ptr<neu::Texture> texture3 = neu::g_resources.Get<neu::Texture>("textures/crate.png"); 
	//texture1->Bind();
